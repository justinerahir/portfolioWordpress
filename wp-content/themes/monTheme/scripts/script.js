...
(function($){
	...
	$.fn.heplbox = function(settings) {
		...
		var setup=function(){
			...
			if(!$overlay.size()){
				...
				if(!$container.size()){
					$container=$('<div class="'+settings.cssPrefix+'container"></div>').css({
		...
		var elementClicked=function(e){
			e.preventDefault();
			curentIndex=elements.indexOf($(this).attr("href"));
			openBox();
		};
		...
		var loadImage=function(){
			...
			var $img=$('<img src="'+elements[curentIndex]+'"/>').css({
   ...
   $(function(){
	...
	// AFFICHE LES INFOS RELATIVES AUX TRAVAUX
	$('.rollover').hide(); // Cache le div de class 'rollover'
	$('.roll').hover(function(){ // Au hover du li de class 'roll' le rollover qui le suit
			$('.rollover', this).fadeIn();
		},
		function(){
			$('.rollover', this).fadeOut(); // Quand il n'y a plus hover du li de class 'roll' le rollover qui le suit se cache
		});
   	});
})(jQuery);
